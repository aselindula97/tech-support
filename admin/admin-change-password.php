...
<body>
	...
	<aside>
		<ul>
			...
			<a href="admin-change-password"><li class="active">Change Password</li></a>
		</ul>
	...
	<div class="content">
		...
		<center>
		<form name="change_pass_form" method="post" action="admin-change-password.php" onSubmit="return validate()">
